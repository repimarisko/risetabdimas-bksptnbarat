...
Route::middleware(['auth', 'verified', 'role:reviewer', 'active_role:reviewer'])
    ...
    ->group(function () {
        ...
        Route::get('/penugasan/{id_skema}/administrasi', [ReviewPtPenelitianController::class, 'listPenugasan'])
            ->name('listPenugasanAdministrasi');

        Route::get('/penugasan/{id_penugasan}/nilai-administrasi', [ReviewPtPenelitianController::class, 'nilaiAdministrasi'])
            ->name('nilaiAdministrasi');
        ...
        Route::get('/penugasan-substansi', [ReviewPtPenelitianController::class, 'indexSkemaSubstansi'])
            ->name('indexSkemaSubstansi');
        Route::get('/penugasan/{id_skema}/substansi', [ReviewPtPenelitianController::class, 'listPenugasanSubstansi'])
            ->name('listPenugasanSubstansi');
        Route::get('/penugasan/{id_penugasan}/nilai-substansi', [ReviewPtPenelitianController::class, 'nilaiSubstansi'])
            ->name('nilaiSubstansi');
        Route::post('/penugasan/{id_penugasan}/simpan-nilai-substansi', [ReviewPtPenelitianController::class, 'storeSubstansi'])
            ->name('storeSubstansi');
        Route::post('/penugasan/{id_penugasan}/selesai-substansi', [ReviewPtPenelitianController::class, 'finalizeSubstansi'])
            ->name('finalizeSubstansi');
        // TIDAK DIPAKAIs
...
Route::middleware(['auth', 'verified', 'role:admin-pt|ketua-lppm|super-admin'])
    ...
    ->group(function () {
        ...
        // Penugasan Review Administrasi dan Substansi
