...
export default function AdminPtSkemaCreate() {
    const { breadcrumbs = [], statusOptions = [], redirectBackUrl, flash } =
    ...
    return (
        <AppHeaderLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat Skema Penelitian" />
            <DashboardNav />
                ...
                <div className="mx-auto max-w-4xl px-4 py-10">
                    <div className="mb-6 flex items-center justify-between gap-3">
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                Lengkapi informasi skema sesuai dengan kolom yang tersedia pada sistem.
                            </p>
                        </div>
                    ...
                    >
                        <div className="border-b border-gray-100 bg-gray-50 px-6 py-5">
                            ...
                            <p className="text-sm text-gray-500">
                                Data dasar skema yang wajib diisi oleh Admin PT.
                            </p>
                        </div>
                        ...
                        <div className="flex items-center justify-between border-t border-gray-100 bg-gray-50 px-6 py-4">
                            <p className="text-sm text-gray-500">
                                Pastikan data yang dimasukkan sudah sesuai sebelum menyimpan skema.
                            </p>
                            <button
                                type="submit"
