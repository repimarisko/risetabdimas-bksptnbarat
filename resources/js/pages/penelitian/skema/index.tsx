...
export default function AdminPtSkemaIndex() {
    ...
    const filterChips = useMemo(() => {
        const options: Option[] = [{ value: '', label: 'Semua' }, ...jenisOptions];
                ...
                <div className="mx-auto max-w-6xl px-4 py-10">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500">
                            Pantau semua skema penelitian/pengabdian yang tersedia dan kelola sesuai kebutuhan.
                        </p>
                    </div>
                            ...
                            <table className="min-w-full text-left text-sm text-gray-900">
                                <thead className="bg-gray-50 text-xs uppercase tracking-wide text-gray-500">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4">Multi Tahun</th>
                                        <th className="px-6 py-4">Rentang Biaya</th>
                                ...
                                <tbody>
                                    {skema.length ? (
                                        skema.map((item) => {
                                            const biayaMinimal =
                                                typeof item.biaya_minimal === 'number'
                                                    ? currencyFormatter.format(item.biaya_minimal)
                                                    : null;
                                            const biayaMaksimal =
                                                typeof item.biaya_maksimal === 'number'
                                                    ? currencyFormatter.format(item.biaya_maksimal)
                                                    : null;
                                            const rentangBiaya =
                                                    ...
                                                    <td className="px-6 py-4">
                                                        ...
                                                        <div className="text-xs text-gray-500">
                                                            {item.nama_singkat
                                                                ...
                                                                : null}
                                                            {item.anggota_min || item.anggota_max ? (
                                                                <span>
                                                                    {item.nama_singkat ? ' • ' : ''}
                                                                    Anggota:
                                                                    {item.anggota_min
                                        ...
                                        <tr>
                                            ...
                                            >
                                                Belum ada skema yang terdaftar. Tambahkan skema baru
                                                untuk memulai.
                                            </td>
                                        </tr>
                                    )}
