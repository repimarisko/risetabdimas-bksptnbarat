...
export default function StepFourView({ onReset, onViewList }: StepFourViewProps) {
    return (
        <div className="bg-white   p-10 text-center">
            <div className="mx-auto flex h-14 w-14 items-center justify-center  bg-green-100 text-green-600">
            ...
            <div className="mt-6 flex justify-center gap-3">
                <button
                    onClick={onViewList}
                    className=" bg-indigo-600 px-4 py-2 text-sm font-semibold text-white  hover:bg-indigo-700"
                >
                    Lihat Daftar
                </button>
                <button
