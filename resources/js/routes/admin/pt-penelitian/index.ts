...
/**
* @see \App\Http\Controllers\Penelitian\AdminPtPenelitianController::indexAll
...
/**
* @see \App\Http\Controllers\Penelitian\AdminPtPenelitianController::assignIndex
* @see app/Http/Controllers/Penelitian/AdminPtPenelitianController.php:160
* @route '/admin/pt-penelitian/assign-reviewer'
*/
export const assignIndex = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: assignIndex.url(options),
    method: 'get',
})

assignIndex.definition = {
    methods: ["get","head"],
...
* @route '/admin/pt-penelitian/assign-reviewer'
*/
assignIndex.url = (options?: RouteQueryOptions) => {
    return assignIndex.definition.url + queryParams(options)
}
...
* @route '/admin/pt-penelitian/assign-reviewer'
*/
assignIndex.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: assignIndex.url(options),
    method: 'get',
})
...
* @route '/admin/pt-penelitian/assign-reviewer'
*/
assignIndex.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: assignIndex.url(options),
    method: 'head',
})
...
* @route '/admin/pt-penelitian/assign-reviewer'
*/
const assignIndexForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: assignIndex.url(options),
    method: 'get',
})
...
* @route '/admin/pt-penelitian/assign-reviewer'
*/
assignIndexForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: assignIndex.url(options),
    method: 'get',
})
...
* @route '/admin/pt-penelitian/assign-reviewer'
*/
assignIndexForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: assignIndex.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
assignIndex.form = assignIndexForm
...
const ptPenelitian = {
    indexAll: Object.assign(indexAll, indexAll),
    deleted: Object.assign(deleted, deleted),
    restore: Object.assign(restore, restore),
    assignIndex: Object.assign(assignIndex, assignIndex),
    export: Object.assign(exportMethod, exportMethod),
    approve: Object.assign(approve, approve),
    reject: Object.assign(reject, reject),
    assignReviewer: Object.assign(assignReviewer, assignReviewer),
